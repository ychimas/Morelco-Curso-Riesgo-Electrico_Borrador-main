...
import riesgoAudio from "../../assets/audio/Sld4_momento_1.mp3";

function M1EnergiaNuestroTrabajo({ backgroundColor = "#005abb" }) {
  return (
          ...
          <div className="row mx-auto">
            ...
            <div className="col-lg-5 col-md-12 h-[90vh] flex flex-col justify-center items-center gap-4">
              <h1 className="text-white text-3xl font-bold">
                M1- La Energía en nuestro trabajo
              </h1>
              <hr style={{width: '100%', border: '1px solid white'}}/>
              <h4 className="text-white text-xl">
              Vamos a identificar <span className="text-secondary-color">los tipos de energías</span> existentes en nuestro trabajo, y la regulación en Colombia
              </h4>
...
export default M1EnergiaNuestroTrabajo;
