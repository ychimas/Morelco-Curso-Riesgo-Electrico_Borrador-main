import section_1 from "../../assets/img/slides/section-2.png";
...
Si nos dirigimos al evento onClick del botón, veremos que se llama a la función setSlideIndex(6).
ese número 6 es el índice de la siguiente slide, por lo que si queremos que el botón nos lleve a la siguiente slide,
...
por lo que si queremos ir a la slide 7, debemos poner 6, ya que los arreglos empiezan en 0.
*/

function ApliquemosSGADivisor() {
      ...
      >
        <div className="flex flex-col text-7xl z-50 justify-center h-full -mt-20 px-40 font-bold content-start ">
          <h1 className="text-white">
            Apliquemos el<span className="text-main-color">.</span>
          </h1>
          <h1 className="text-white">
            SGA<span className="text-main-color">.</span>
          </h1>
          <h1 className="text-white">
...
export default ApliquemosSGADivisor;
