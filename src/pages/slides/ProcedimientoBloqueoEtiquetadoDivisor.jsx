...
function ProcedimientoBloqueoEtiquetadoDivisor({
  ...
  return (
    <div className="container slider02 relative min-h-screen p-0 m-0">
      ...
      >
        ...
        <div className="flex flex-col text-[25px] md:text-[70px] z-50 justify-center h-full -mt-20 px-16 sm:px-40 font-bold content-start">
...
export default ProcedimientoBloqueoEtiquetadoDivisor;
